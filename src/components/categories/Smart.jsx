...
export default function Smart({_id, img, title, price, info, user, handleDetail, addToCart}) {
  ...
  const submit = (_id) =>{
      ...
      <div className="product-card d-flex flex-column h-100 pb-2">
        <Link to='/details'>
          <img src={img} onClick={()=> handleDetail(_id)} alt="" className="img-border w-100" style={{height: '200px'}}/>
        </Link>
