      ...
      <div className="recommended bg-white">
        ...
        <div className="recommended-overflow">
          {recommended.map((item)=>{
            const {_id, img, title, price, per, info} = item;
            return (
              <div key={_id} onClick={()=> handleDetail(_id)} className='recommended-card col-5 col-md-3 col-lg-2'>
                <Link to='/details'>
                  <img src={img} alt="" style={{height: '200px'}} className='w-100 mb-3 rounded'/>
                  <h6>{title}</h6>
                  <div className="text-muted">{info.substring(0, 40)}</div>
        ...
        <div className="row">
          {defacto.map((item, index)=>{
            ...
            if (index < 4) {
              return (
                <div className="col-6 col-md-3 mx-auto">
                  <div key={_id} onClick={()=> handleDetail(_id)} className='recommended-card mx-auto'>
                    <Link to='/details'>
                      <img src={img} alt="" style={{height: '200px'}} className='w-100 mb-3 rounded'/>
                      <h6>{title}</h6>
                      <div className="text-muted">{info.substring(0, 40)}</div>
